...
export default function LivePanel({ bp }) {
  ...
  return (
    <div style={{ maxWidth: 1800, margin: '0 auto', display: 'flex', gap: 20, alignItems: 'flex-start', minHeight: 'calc(100vh - 80px)', overflowX: 'hidden' }}>
      <style>{`
      ...
      {isMobile ? null : (
        <div style={{ width: 240, flexShrink: 0 }}>
          <Card style={{ background: 'rgba(10,10,12,0.9)', padding: 16, borderRadius: 14 }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
              <span style={{ fontSize: 11, fontWeight: 600, color: 'rgba(255,255,255,0.4)', letterSpacing: 1, textTransform: 'uppercase' }}>Watchlist</span>
            </div>
                ...
                return (
                  <div 
                    ...
                    style={{ 
                      ...
                      borderRadius: 10, 
                      cursor: 'pointer', 
                      background: sym === ticker ? 'rgba(0,255,136,0.08)' : 'transparent', 
                      border: sym === ticker ? '1px solid rgba(0,255,136,0.15)' : '1px solid transparent',
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                      ...
                      <div>
                        <div style={{ fontSize: 13, fontWeight: 600, color: '#fff', fontFamily: "'DM Sans', sans-serif" }}>{sym}</div>
                        <div style={{ fontSize: 12, fontWeight: 400, color: 'rgba(255,255,255,0.5)', fontFamily: "'DM Mono', monospace" }}>${displayPrice?.toFixed(2) || '—'}</div>
                      </div>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      <div style={{ textAlign: 'right' }}>
                        <div style={{ 
                          ...
                          fontWeight: 600, 
                          fontFamily: "'DM Mono', monospace",
                          color: displayChange != null ? (wPositive ? '#00ff88' : '#ff5050') : 'rgba(255,255,255,0.3)' 
                        }}>
                          {displayChange != null ? (wPositive ? '+' : '') + displayChange.toFixed(2) + '%' : '—'}
                        </div>
                      </div>
                      <button
